...
from DIFFI.sklearn_mod_functions import *
...
def local_diffi(iforest, x):
    ...
    # print("max_samples", iforest.max_samples)
    # print("max_samples_", iforest.max_samples_, min(256, iforest.max_samples_))
    # max_depth = int(np.ceil(np.log2(iforest.max_samples)))
    max_depth = int(np.ceil(np.log2(min(256, iforest.max_samples_))))
    # for every iTree in the iForest
